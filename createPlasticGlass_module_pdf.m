...
png.set_of_Ps = {'pGlassMagazine', 'pInCreateGlass', 'pOutCreateGlass', 'pDelivery', 'pMachineStateGlass'};
...
png.set_of_As = {'tCreateGlassIn', 'pGlassMagazine', 1, 'pGlassMagazine', 'tInGlassMachine', 1, ...
                ...
                'tOutGlassMachine', 'pDelivery', 1, 'tOutGlassMachine', 'pMachineStateGlass', 1, ...
                'pMachineStateGlass', 'tInGlassMachine', 1, 'pDelivery', 'tCreateGlassOut', 1};
