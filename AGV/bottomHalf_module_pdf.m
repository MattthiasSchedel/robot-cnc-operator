...
png.set_of_Ps = {'pBottomMagazine', 'pInBottomMold', 'pOutBottomMold', 'pBottomDelivery', 'pMachineStateBottom'};
...
png.set_of_As = {'tBottomMoldIn', 'pBottomMagazine', 1, 'pBottomMagazine', 'tInMoldMachine', 1, ...
                ...
                'tOutMoldMachine', 'pBottomDelivery', 1, 'tOutMoldMachine', 'pMachineStateBottom', 1, ...
                'pMachineStateBottom', 'tInMoldMachine', 1, 'pBottomDelivery', 'tBottomMoldOut', 1};
